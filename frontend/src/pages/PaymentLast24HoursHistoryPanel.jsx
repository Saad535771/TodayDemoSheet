...
export default function PaymentLast24HoursHistoryPanel({ open, onClose, paymentCloneId }) {
  ...
  async function loadData() {
    try {
      ...
      const res = await api.get("/payment-change-requests/logs/last-24-hours", { params });
