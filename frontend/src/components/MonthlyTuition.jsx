  ...
  return (
    <div style={styles.card}>
      ...
      <form onSubmit={create} style={styles.singleLineForm} onKeyDown={handleKeyDown}>
        ...
        <CreateField label="OTM Name" val={form.otmName} onChange={v => setCreateField("otmName", v)} width="120px" />
...
function CreateField({ label, val, onChange, type = "text", width = "120px" }) {
  return (
    <div style={{ minWidth: width }}>
      <label style={{ fontSize: 11, fontWeight: "bold", color: "#666", marginBottom: 2, display: "block" }}>
        {label}
      </label>
      <input
        type={type}
        style={{ width: "100%", padding: "8px", border: "1px solid #c8c6c4", fontSize: "12px", boxSizing: "border-box", fontFamily: "'Calibri', sans-serif", background: "white", outline: "none" }}
        value={val || ""}
